...
export function stageRuntime(packageRoot, output) {
  ...
  fs.writeFileSync(path.join(output, 'manifest.json'), JSON.stringify({
    ...
    lifecycleModule, patches: ['native-sqlite-ownership', 'native-gateway-loop-export', 'native-recovery-source-run', 'native-ios-restart-safe-admission', 'native-search-completion-log']
  }, null, 2));
}
