...
public enum GatewayNativeNodeSurface {
    ...
    public static let commandPolicyAllow = ["contacts.resolve", "photos.search", "music.nowPlaying", "music.search", "weather.forecast", "device.status", Self.messageComposeCommand, "maps.search", "maps.directions", "apps.open", "whatsapp.chats", "whatsapp.messages", "whatsapp.sync", "whatsapp.compose", "connections.read", "connections.write", "connections.describe", "notion.tools", "notion.call", "youtube.search", "youtube.open", "podcasts.search", "podcasts.open"]
