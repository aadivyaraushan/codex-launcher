...
final class OpenClawNodeConnectionTests: XCTestCase {
    ...
    func testConnectAdvertisesForegroundLocationAndCalendarAsAnIOSNode() async throws {
        ...
        XCTAssertEqual(params["caps"] as? [String], ["location", "calendar", "sms", "maps", "apps", "whatsapp", "accounts", "notion", "media"])
        XCTAssertEqual(params["commands"] as? [String], ["location.get", "calendar.events", "sms.compose", "maps.search", "maps.directions", "apps.open", "whatsapp.chats", "whatsapp.messages", "whatsapp.sync", "whatsapp.compose", "connections.read", "connections.write", "connections.describe", "notion.tools", "notion.call", "youtube.search", "youtube.open", "podcasts.search", "podcasts.open"])
