...
final class GatewayNodePairingTests: XCTestCase {
    ...
    func testApprovesOnlyMatchingOwnPendingNativeSurface() async throws {
        ...
        {"pending":[{"requestId":"pending-own","nodeId":"device-own","caps":["location","calendar","sms","maps","apps","whatsapp","accounts","notion","media"],"commands":["location.get","calendar.events","sms.compose","maps.search","maps.directions","apps.open","whatsapp.chats","whatsapp.messages","whatsapp.sync","whatsapp.compose","connections.read","connections.write","connections.describe","notion.tools","notion.call","youtube.search","youtube.open","podcasts.search","podcasts.open"]}],"paired":[]}
        """, approvePayload: """
        {"requestId":"pending-own","node":{"nodeId":"device-own","caps":["location","calendar","sms","maps","apps","whatsapp","accounts","notion","media"],"commands":["location.get","calendar.events","sms.compose","maps.search","maps.directions","apps.open","whatsapp.chats","whatsapp.messages","whatsapp.sync","whatsapp.compose","connections.read","connections.write","connections.describe","notion.tools","notion.call","youtube.search","youtube.open","podcasts.search","podcasts.open"]}}
        """)
    ...
    func testAlreadyApprovedExactSurfaceDoesNotWrite() async throws {
        let fixture = try await PairingFixture.make(listPayload: """
        {"pending":[],"paired":[{"nodeId":"device-own","caps":["sms","calendar","location","maps","apps","whatsapp","accounts","notion","media"],"commands":["sms.compose","calendar.events","location.get","maps.search","maps.directions","apps.open","whatsapp.chats","whatsapp.messages","whatsapp.sync","whatsapp.compose","connections.read","connections.write","connections.describe","notion.tools","notion.call","youtube.search","youtube.open","podcasts.search","podcasts.open"],"permissions":{}}]}
        """)
    ...
    func testForeignPendingIsIgnoredWhenOwnApprovedSurfaceMatches() async throws {
        let fixture = try await PairingFixture.make(listPayload: """
        {"pending":[{"requestId":"foreign","nodeId":"device-foreign","caps":["location","calendar","sms","maps","apps","whatsapp","accounts","notion","media"],"commands":["location.get","calendar.events","sms.compose","maps.search","maps.directions","apps.open","whatsapp.chats","whatsapp.messages","whatsapp.sync","whatsapp.compose","connections.read","connections.write","connections.describe","notion.tools","notion.call","youtube.search","youtube.open","podcasts.search","podcasts.open"]}],"paired":[{"nodeId":"device-own","caps":["location","calendar","sms","maps","apps","whatsapp","accounts","notion","media"],"commands":["location.get","calendar.events","sms.compose","maps.search","maps.directions","apps.open","whatsapp.chats","whatsapp.messages","whatsapp.sync","whatsapp.compose","connections.read","connections.write","connections.describe","notion.tools","notion.call","youtube.search","youtube.open","podcasts.search","podcasts.open"]}]}
        """)
